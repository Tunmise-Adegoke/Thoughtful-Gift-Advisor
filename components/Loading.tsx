  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center min-h-[500px] w-full max-w-lg mx-auto overflow-hidden">
      ...
      <div className="relative w-64 h-64 flex items-center justify-center mb-8">
        ...
        {/* Central Gift Box */}
        <div className="relative z-10 bg-white p-4 rounded-full border border-orange-100 shadow-[0_10px_40px_-10px_rgba(255,90,95,0.4)]">
            <Gift size={48} className="text-joy-accent animate-pulse" strokeWidth={1.5} />
        </div>
        ...
        <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute top-0 left-10 animate-drop-in" style={{ animationDelay: '0s' }}>
                <Watch size={24} className="text-joy-secondary" />
            </div>
            
            {/* Item 2: Top Right */}
            <div className="absolute top-4 right-12 animate-drop-in" style={{ animationDelay: '0.6s' }}>
                <Smartphone size={24} className="text-joy-accent" />
            </div>
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-orange-100/50 to-transparent rounded-full blur-3xl -z-10"></div>
      </div>

      {/* Text Updates */}
      <div className="text-center space-y-3 h-20 px-4">
        <h3 className="text-2xl font-serif text-joy-text animate-fade-in key-{msgIndex}">
      ...
      <div className="w-48 h-1 bg-gray-200 rounded-full mt-8 overflow-hidden">
        <div className="h-full bg-joy-accent/50 w-full animate-[slideUp_2s_ease-in-out_infinite] origin-left transform -translate-x-full"></div>
      </div>
